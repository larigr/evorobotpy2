...
class WalkerBaseBulletEnv(MJCFBaseBulletEnv):
  ...
  def resetN(self):
    ...
    self.r = MJCFBaseBulletEnv.reset(self)
  ...
  def step(self, a):
    ...
    self.distancia = self.robot.walk_target_dist
    #print(self.old_distancia - self.distancia)

    positions = []
    for joint in self.robot.ordered_joints:      #print(f"joint {x} position:",end=" ")
      positions.append('%.2f' % joint.get_position())
    self.angulos = positions
    self.velocity = self.old_distancia - self.distancia
    self.old_distancia = self.distancia
    ...
    #print(self.robot.ordered_joints[0].__dict__)
  ...
  def state_change(self):
    if self.state_is == 'remove_abonus':
      self._alive = 0
    elif self.state_is == 'double_progress':
      self.rewards[1] *= 2  
    
    elif self.state_is == 'less_abonus':
      self._alive *= 0.20
    else:
      pass#print(self.state_is)
